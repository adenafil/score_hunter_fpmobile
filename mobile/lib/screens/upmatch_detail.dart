...
class _UpmatchDetailState extends State<UpmatchDetail> {
  ...
  Future<void> fetchUpcomingMatches() async {
    try {
      ...
      leagueName =
          await votesService.fetchLeagueName(matchId); // Ambil nama liga
                  ...
                  child: Column(
                    children: [
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      int matchId = widget.upcomingMatch
                                          .matchId; // Ambil matchId dari objek upcomingMatch
                                      String username =
                                          'user123'; // Gantilah dengan username pengguna yang aktif
                                      int type = 1;
                                      String answer = "0";

                                      if (guestCategoryItems[current] ==
                                          "Regular Time") type = 1;
                                      if (guestCategoryItems[current] ==
                                          "1st Half Time") type = 2;
                                      if (guestCategoryItems[current] ==
                                          "2nd Half Time") type = 3;
                                      if (guestCategoryItems[current] ==
                                          "First to Happen") type = 4;

                                      // Memanggil method postGuessMatch
                                      String message =
                                          await service.postGuessMatch(
                                        type: type,
                                        answer: answer,
                      ...
                      Container(
                        ...
                        width: 80,
                        child: Image.asset('assets/img/score_hunter_logo.png'),
                      ),
                    ],
                  ),
                ),
